...
export class JobsComponent {
  ...
  setBackground(setNumber: any) {
    switch (setNumber) {
      case 1: this.divBackgroundColor1 = this.setColor;
        break;
      case 2: this.divBackgroundColor2 = this.setColor;
        break;
      case 3: this.divBackgroundColor3 = this.setColor;
        break;
      case 4: this.divBackgroundColor4 = this.setColor;
        break;
      case 5: this.divBackgroundColor5 = this.setColor;
        break;
    }
  }
